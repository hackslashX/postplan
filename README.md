...
npm install
npm run build
PUBLIC_BASE_URL=https://postplan.com PORT=3000 npm start
```
...
Put this service behind TLS. Configure a reverse proxy to accept a 25 MB request body at minimum if binary uploads are needed.
